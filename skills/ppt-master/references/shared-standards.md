...
- **Minimum font size**: body text ≥ 12pt (≈16px), subtitle ≥ 14pt (≈19px), all higher headings strictly larger than subtitle. These are hard floors — never go below for readability in presentation mode.
